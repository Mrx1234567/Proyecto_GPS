...
key ="AGvUQBLCxDFu1Eex1y8p1zBYLTAkvHRg"
...
while True:
    ...
    if status_code==0:
        ...
        for each in json_data["route"]["legs"][0]["maneuvers"]:
            distance_reamining = distance - each["distance"] *1.61

            print(each["narrative"] +"  (" + str("{:.2f}".format(distance_reamining)) + "Km faltantes)")
            distance = distance_reamining
